...
Parse and analyze Apple Health export ZIP archives. Transforms raw `export.xml` and auxiliary data into structured CSV summaries (`records-<Type>.csv`, `workouts-<Type>.csv`, `activity_summaries.csv`, `user.csv`) and generates markdown-formatted health reports.
